...
class TestInc_initial(TestCase):
    ...
    def bench(self):
        ...
        inc_initial_1 = top(top.__name__, count, enable, clock, reset, n=n).convert(hdl='SystemVerilog')
        inc_initial_v = top(top.__name__, count_v, enable, clock, reset, n=n).convert(hdl='SystemVerilog')
