...
# #                            Pow,
                           ...
                           And,
                           Or,
                           left, right, sbit).convert(hdl='SystemVerilog')
...
# #               Mod,
    ...
    @instance
    def comb():
        var1 = intbv(0, min=-2 ** 17, max=+2 ** 17)
...
class TestExpressions(TestCase):
    ...
    def bench(self):
        ...
        expr = expressions(a, b, clk).convert(hdl='SystemVerilog')
        expr_v = expressions(a_v, b_v, clk).convert(hdl='SystemVerilog')
