...
class TestInc(TestCase):
    ...
    def bench(self, incRef, incVer):
        ...
        inc_inst = incVer(count, enable, clock, reset, n=n).convert(hdl='SystemVerilog')
    ...
    def testIncGen(self):
        ...
        clock, reset = [Signal(bool()) for __ in range(2)]
        try:
            inc_inst = incGen(count_v, enable, clock, reset, n=n).convert(hdl='SystemVerilog')
    ...
    def testIncErr(self):
        ...
        try:
            inc_inst = incErr(count_v, enable, clock, reset, n=n).convert(hdl='SystemVerilog')
